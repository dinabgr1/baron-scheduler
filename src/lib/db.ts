...
export type Pilot = { id: string; name: string; phone: string|null; email: string|null; license_number: string|null; is_active: number; created_at: string }
...
export type MaintenanceRecord = { id: string; maintenance_type: string; last_done_date: string|null; last_done_hobbs: number; interval_hours: number|null; interval_months: number|null; notes: string|null; visible_to_pilots: number; created_at: string; updated_at: string }
